...
MODULES_DIR="/var/www/_bases/base_survey_module_fila4_mono/laravel/Modules"
...
for module in Activity AI Blog Chart CloudStorage Cms Comment DbForge Application Gdpr Geo Job Lang Limesurvey Media Notify SurveyModule Rating Seo Tenant UI User Xot; do
