...
return [
    ...
    'fields' => [
        ...
        'ip_address' => ['label' => 'ip_address', 'placeholder' => 'ip_address', 'helper_text' => '', 'description' => 'ip_address'],
        'user_agent' => ['label' => 'user_agent', 'placeholder' => 'user_agent', 'helper_text' => '', 'description' => 'user_agent'],
        'payload' => ['label' => 'payload', 'placeholder' => 'payload', 'helper_text' => '', 'description' => 'payload'],
        'last_activity' => ['label' => 'last_activity', 'placeholder' => 'last_activity', 'helper_text' => '', 'description' => 'last_activity'],
    ],
    'actions' => [
