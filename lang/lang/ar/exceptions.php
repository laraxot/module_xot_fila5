...
// File: lang/lang/ar/exceptions.php
return [
    'backend' => [
        'access' => [
            'roles' => [
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'حسابك غير مفعل. برجاء الضغط على رابط التفعيل الذي تم إرساله إلى بريدك الإلكتروني, أو إضغط هنا</a> لإعادة إرسال رابط التفعيل مجددا.',
