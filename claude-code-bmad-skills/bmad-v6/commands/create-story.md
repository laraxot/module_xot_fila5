...
4. **GitHub:** per ogni repo owner (`base_fixcity_fila5`, `module_*_fila5`, `theme_*_fila5`) preparare issue + discussion; i link **devono** finire in `## GitHub (tracciamento)` nel file story (URL completi).
5. **Get story input:**
...
| Tipo | Repo | # | URL |
|------|------|---|-----|
| **Issue** (story owner) | laraxot/base_fixcity_fila5 | N | https://github.com/laraxot/base_fixcity_fila5/issues/N |
| **Discussion** (story owner) | laraxot/base_fixcity_fila5 | N | https://github.com/laraxot/base_fixcity_fila5/discussions/N |

(Creare issue/discussion con `gh` prima di salvare; aggiungere righe per ogni module_* / theme_* owner.)
