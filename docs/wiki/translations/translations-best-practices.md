...
- [LangServiceProvider](<nome repository>/laravel/Modules/Xot/Providers/LangServiceProvider.php)
- [TRANSLATIONS.md](<nome repository>/laravel/modules/brain/project_docs/translations.md)