...
- Usare Actions non Services (vedi [actions-over-services-governance](https://github.com/laraxot/<nome repitory>/blob/main/.opencode/skills/actions-over-services-governance/SKILL.md))
