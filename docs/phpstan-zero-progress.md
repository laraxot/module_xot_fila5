...
- I generatori PDF Notify e SurveyModule delegano a `HtmlToPdfAction` invece di riferirsi al rimosso `HtmlService`.
- Fixture e test obsoleti sono stati riallineati alle classi realmente disponibili.

## Verifica

I moduli che comparivano nell'ultimo report completo (`AI`, `Activity`, `Geo`, `Notify`, `SurveyModule`, `Xot`) passano PHPStan quando analizzati singolarmente. I test mirati modificati passano.
