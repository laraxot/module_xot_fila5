...
<<<<<<< HEAD
<<<<<<< HEAD
| <repo progetto> | v5.3.0 | v12.53.0 | v4.2.1 | v1.1.13 | v12.0.4 |
| <repo progetto> | v5.0.0 | v12.47.0 | v4.0.1 | n/a | v12.0.4 |
| <repo progetto> | v5.2.2 | v12.52.0 | v4.1.4 | dev-master | v12.0.4 |
...
4. `<repo progetto>` è il più arretrato nel cluster Fila5 (filament `v5.0.0`): utile come benchmark retrocompatibilità.
=======
=======
>>>>>>> laraxot/dev
>>>>>>> laraxot/dev
