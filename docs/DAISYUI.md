...
Tutte le sue view sono estese da moduli consumatori (Application, Geo, ecc.) che le fanno girare nel **tema Sixteen**.
...
|-----------|-------------|
| Nessun overhead — già ereditato dal tema | Tutti i consumatori (Application, Geo, ecc.) usano Sixteen |
