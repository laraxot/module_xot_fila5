...
- [Infinite Loop Prevention](../critical-fixes/infinite-loop-prevention.md) — se il path è assente nel clone, cercare nella wiki modulo con `qmd`.
...
*Documento canonico (nome file minuscolo, maggio 2026). Variante sintetica: [`infinite-loop-getstepbyname-fix-1.md`](./infinite-loop-getstepbyname-fix-1.md). Alias storico con maiuscole: [`infinite-loop-getStepByName-fix.md`](./infinite-loop-getStepByName-fix.md).*
