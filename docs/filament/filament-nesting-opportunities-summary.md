...
**Documentazione**: [Modules/SurveyModule/docs/filament-nesting-opportunities.md](../../SurveyModule/docs/filament-nesting-opportunities.md)
...
1. **Contact Nested Resource** (SurveyModule)
2. **SurveyPdf Nested Resource** (SurveyModule)
...
```bash
php artisan make:filament-resource Contact --nested --module=SurveyModule
```
...
- [SurveyModule Nesting Opportunities](../../SurveyModule/docs/filament-nesting-opportunities.md)
