...
- Rules: no --force push; fetch laraxot/dev prima; User -> UserContract; docs aggiornati
- Status: Branch fix/phpstan-issues creato; XotBaseMainPanelProvider fixato; await module sync
