<<<<<<< HEAD
---
name: filament-v4-upgrade-notes
description: "This document outlines specific considerations and changes for the Xot module, particularly concerning its foundational XotBaseSection compo"
metadata:
  type: documentation
---
