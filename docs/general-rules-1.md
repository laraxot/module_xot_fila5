---
name: general-rules-1
description: "Questo documento contiene le regole generali che devono essere seguite in tutto il progetto <nome progetto> per garantire coerenza e qualità"
metadata:
  type: documentation
---
