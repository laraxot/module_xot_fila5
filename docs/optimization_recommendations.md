...
```php
// ❌ PROBLEMA ATTUALE
public static string $projectBasePath = '/var/www/html/application';
public static string $laravelBasePath = '[project-root]/laravel';
```
...
grep -r "/var/www/html/application" Modules/Xot/ --include="*.php"
