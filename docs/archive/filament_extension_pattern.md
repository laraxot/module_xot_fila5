...
=======
namespace Modules\healthcare_app\Filament\Resources\Pages;
...
=======
- [errore override metodo final](/var/www/html/base_healthcare_app/laravel/docs/errors/filament_final_method_override.md)
- [linee guida filament](/var/www/html/base_healthcare_app/laravel/Modules/healthcare_app/docs/filament-resources.md)
>>>>>>> 8116fe6a (docs: replace project-specific references with generic placeholders across documentation)
