...
Dal file `app/Models/Client.php` ho identificato i seguenti campi di contatto:
...
ViewColumn::make('contatti')
    ->label('Contatti')
    ->view('planning_module::filament.columns.contacts')
    ->searchable(['phone', 'mobile', 'email', 'pec', 'whatsapp'])
```
...
- [UI Icons System](../../ui/project_docs/icons.md)
- [PlanningModule Client Model](../../PlanningModule/app/Models/Client.php)
