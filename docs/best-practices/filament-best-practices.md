...
description: "Questo documento riassume le migliori pratiche per la creazione e gestione delle risorse Filament all'interno dell'ecosistema Laraxot. Segui"
metadata:
  type: best-practice
---
...
- [Documentazione XotBaseResource](<repo progetto>/laravel/modules/xot/docs/resource.md)
- [Best Practices Laraxot](<repo progetto>/laravel/modules/xot/docs/best-practices.md)
=======
=======
>>>>>>> laraxot/dev
>>>>>>> laraxot/dev
