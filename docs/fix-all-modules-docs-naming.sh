...
for module in Activity AI Blog Chart CloudStorage Cms Comment DbForge Application Gdpr Geo Job Lang Limesurvey Media Notify <nome progetto> Rating Seo Tenant UI User Xot; do
