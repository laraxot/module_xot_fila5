...
protected function getStats(): array
{
    if ($this->record === null) {
        return [
            Stat::make(__('survey_module::question_chart_stats_overview.stats.total_responses.label'), '0')
                ->description(__('survey_module::question_chart_stats_overview.messages.no_data_available'))
                ->color('gray'),
        ];
    }
...
{
    return Stat::make(
        __('survey_module::question_chart_stats_overview.stats.total_responses.label'),
        number_format((float) $count)
    )
        ->description(__('survey_module::question_chart_stats_overview.stats.total_responses.description'))
...
{
    return Stat::make(
        __('survey_module::question_chart_stats_overview.stats.completion_rate.label'),
        $rate.'%'
    )
        ->description(__('survey_module::question_chart_stats_overview.stats.completion_rate.description'))
