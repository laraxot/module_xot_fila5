# Regole Fondamentali per Prompt AI - SurveyModule Fila5 Mono
...
```
Create/Update code for SurveyModule Fila5 Mono with these CRITICAL rules:
...
### Per Test Generation
```
Create test for ProfileService in SurveyModule Fila5 Mono with these rules:
...
```
Create ProfileService for SurveyModule Fila5 Mono following these patterns:
...
```
Create Filament resource extending XotBaseResource for SurveyModule Fila5 Mono:
...
### Modulo SurveyModule
```
SurveyModule module specific requirements:
