...
translation is not just a feature: it is part of governance (no hardcoded labels, consistent keys, deterministic ui).
...
- **reason**:
  ...
  - a single contract enables type-safety, deterministic behavior, and prevents “magic divergence”.
