...
./vendor/bin/phpstan analyse Modules/SurveyModule/app/Filament/Widgets/SimpleChartWidget.php --memory-limit=-1 --level=10
```

### Testing Coverage
```bash
# ✅ 100% coverage per metodi principali
./vendor/bin/phpunit --coverage-html=coverage Modules/SurveyModule/tests/Unit/SimpleChartWidgetTest.php
```
