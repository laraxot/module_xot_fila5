# 🤖 Configurazione MCP per PlanningModule Fila4 Mono

## Panoramica

Questa documentazione descrive la configurazione del Model Context Protocol (MCP) ottimizzata per il progetto PlanningModule Fila4 Mono, un'applicazione Laravel modulare basata sull'architettura Laraxot.
...
### Supporto per Moduli
- Accesso diretto a tutti i moduli (Xot, User, PlanningModule, ecc.)
