...
**File**: `/Modules/SurveyModule/docs/PROPERTY_CONFLICT_RESOLUTION_FILAMENT_TRAITS.md`
...
- [Spatie Laravel Data](https://spatie.be/docs/laravel-data)
- `/Modules/Xot/docs/FILAMENT_4_LARAXOT_RULES.md`
- `/Modules/SurveyModule/docs/PROPERTY_CONFLICT_RESOLUTION_FILAMENT_TRAITS.md`
