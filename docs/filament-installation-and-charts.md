...
// Modules/SurveyModule/app/Providers/Filament/AdminPanelProvider.php
...
public function panel(Panel $panel): Panel
{
    ...
    // FilamentAsset::register([
    //     Js::make('chart-js-plugins', Vite::asset('resources/js/filament-chart-js-plugins.js', 'assets/survey_module'))->module(),
    // ]);
